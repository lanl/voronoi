...
class Voronoi():
    def __init__(self, nprocs: int, infile: str, output: str, infile_is_lgi: bool = None, output_type: str = None, compute_median: bool = False, show_diagnostics: bool = False, extra_flags: str = ""):
        '''
